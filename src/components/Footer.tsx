      ...
      <div className="max-w-4xl mx-auto space-y-8 text-xs text-center md:text-left">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="space-y-1.5">
            <p className="font-bold text-neutral-200">Kit Destrava Sessão Kids © {currentYear}</p>
            <p className="text-[11px] text-neutral-500">Todos os direitos reservados. Recursos lúdicos de apoio terapêutico profissional para crianças.</p>
          </div>
        ...
        <div className="border-t border-neutral-800 pt-6 text-[10px] text-neutral-500 max-w-4xl leading-relaxed text-justify space-y-2">
          <p>
            <strong>Disclaimer:</strong> Este produto é um material digital educativo destinado a profissionais e estudantes da área de saúde mental. Os recursos não substituem formação profissional, avaliação individualizada, supervisão clínica, diagnóstico, protocolos específicos ou acompanhamento especializado. A seleção e a aplicação de cada material são de responsabilidade do profissional, considerando sua abordagem, qualificação, contexto clínico e as necessidades individuais de cada criança. Os resultados podem variar de acordo com cada caso, contexto e forma de utilização.
          </p>
        </div>
