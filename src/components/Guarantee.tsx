      ...
      <div className="max-w-3xl mx-auto bg-[#fafafa] border border-neutral-200/50 rounded-3xl p-6 md:p-10 shadow-sm flex flex-col md:flex-row gap-8 items-center">
        ...
        <div className="flex-1 space-y-4 text-center md:text-left">
          ...
          <p className="text-gray-600 text-sm md:text-base leading-relaxed">
            Você tem 15 dias para acessar o kit, explorar os materiais e avaliar como os recursos podem complementar suas sessões infantis. Caso não fique satisfeita, poderá solicitar o reembolso dentro do período de garantia, de acordo com as condições da plataforma de pagamento. Sem burocracia.
          </p>
