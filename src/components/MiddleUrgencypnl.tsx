    ...
    <section id="middle-urgency-section" className="py-20 px-4 bg-gradient-to-br from-[#12665e] via-[#10564f] to-[#0d4640] text-white text-center relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto relative z-10 space-y-6">
        ...
        <p id="middle-urgency-p" className="text-teal-100 text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
          A criança que não se engaja pode começar a achar as sessões entediantes. Os pais que não percebem evolução podem começar a questionar o processo terapêutico. E você não precisa entrar em cada atendimento improvisando brincadeiras ou esperando que a pergunta certa apareça de forma mágica. Você merece ter recursos que ajudem a organizar a sessão, estimular a participação e tornar seus atendimentos mais lúdicos, leves e seguros.
        </p>
