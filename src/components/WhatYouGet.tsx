...
export default function WhatYouGet({ scrollToOffer }: WhatYouGetProps) {
  const mainFeatures = [
    "Cartas para identificação de emoções infantis",
    "Jogos e dinâmicas lúdicas para quebrar o gelo",
    "Recursos visuais para ansiedade infantil",
    "Atividades de autoestima e autoconfiança",
    "Materiais para psicoeducação sobre TDAH e foco",
    "Combinados de comportamento e rotina",
    "Escalas visuais para regulação emocional",
    "Recursos lúdicos para luto e mudanças de ciclo",
    "Fichas para trabalhar medos e pesadelos",
    "Exercícios lúdicos para frustração e raiva",
    "Atividades para timidez e interação social",
    "Estratégias lúdicas para crianças resistentes",
    "Checklists e planejadores visuais",
    "Materiais de psicoeducação visual para pais",
    "Exercícios de respiração e aterramento lúdicos"
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center mb-20">
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative w-full max-w-sm aspect-square flex items-center justify-center select-none">
              <img
                src="https://i.ibb.co/MDjGJnDw/Chat-GPT-Image-17-de-jul-de-2026-20-32-08.png"
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="space-y-1">
              ...
              <h3 className="font-sans font-black text-2xl md:text-3xl text-gray-950">Kit Destrava Sessão Kids</h3>
              <p className="text-gray-500 font-bold text-sm uppercase tracking-wide">+160 recursos terapêuticos para atendimento de crianças</p>
            </div>
                ...
                <div className="space-y-4">
                  ...
                  {idx === 0 && (
                    <div className="overflow-hidden bg-transparent my-3">
                      <img 
                        src="https://i.ibb.co/yns7DXMs/Chat-GPT-Image-17-de-jul-de-2026-20-42-53-1.png" 
                  ...
                  {idx === 1 && (
                    <div className="overflow-hidden bg-transparent my-3">
                      <img 
                        src="https://i.ibb.co/8nNh1J9s/Chat-GPT-Image-17-de-jul-de-2026-20-42-54-4.png" 
                  ...
                  {idx === 2 && (
                    <div className="overflow-hidden bg-transparent my-3">
                      <img 
                        src="https://i.ibb.co/zhmcx8bc/Chat-GPT-Image-17-de-jul-de-2026-20-42-54-3.png" 
                  ...
                  {idx === 3 && (
                    <div className="overflow-hidden bg-transparent my-3">
                      <img 
                        src="https://i.ibb.co/cKF9gjJX/Chat-GPT-Image-17-de-jul-de-2026-20-42-55-5.png" 
                        alt="Bônus 04" 
                        className="w-full h-auto object-cover hover:scale-102 transition duration-300"
                        referrerPolicy="no-referrer"
                      />
                  ...
                  {idx === 4 && (
                    <div className="overflow-hidden bg-transparent my-3">
                      <img 
                        src="https://i.ibb.co/N6r3WL47/Chat-GPT-Image-17-de-jul-de-2026-20-42-53-2.png" 
                        alt="Bônus 05" 
                        className="w-full h-auto object-cover hover:scale-102 transition duration-300"
                        referrerPolicy="no-referrer"
                      />
