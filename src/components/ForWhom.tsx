      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 id="for-whom-title" className="font-sans font-black text-3xl md:text-4xl text-gray-900 tracking-tight leading-tight">
            Se você já ficou sem saber como conduzir ou aprofundar uma sessão lúdica, <span className="text-[#1ca296]">esse kit é para você</span>
          </h2>
          <p id="for-whom-subtitle" className="text-gray-500 mt-4 text-sm md:text-base max-w-xl mx-auto leading-relaxed font-semibold">
            Cada recurso foi pensado para ajudar você a conduzir sessões lúdicas de maneira estruturada.
          </p>
          <div className="mt-4 p-4 bg-teal-50/40 rounded-2xl border border-teal-100/60 max-w-2xl mx-auto text-left text-xs md:text-sm text-gray-600 space-y-2 leading-relaxed">
            <p>Sabe aquele momento em que a criança se fecha, diz que não sabe o que sente ou muda de assunto quando o assunto fica sério?</p>
            <p>Ou quando os pais trazem uma demanda difícil e você precisa de recursos práticos prontos para usar no consultório ou no online?</p>
          </div>
        </div>
        ...
        <div className="text-center space-y-6">
          ...
          <p className="text-xs md:text-sm text-gray-500 italic max-w-xl mx-auto leading-relaxed">
            Essas são apenas algumas das situações de consultório abordadas. O Kit Destrava Sessão Kids oferece caminhos lúdicos para ajudar no acolhimento, na expressão emocional e no direcionamento de sessões com crianças.
          </p>
        </div>
