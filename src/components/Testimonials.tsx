...
const CLINICAL_TESTIMONIALS = [
  {
    id: "depo-1",
    title: "Sessões mais participativas",
    name: "Nome da profissional",
    role: "Psicóloga Infantil",
    photoUrl: "https://i.ibb.co/qMPnDyd1/f2e6e55bddcb8003dc70699fadb64840.jpg",
    quote: "[INSIRA AQUI UM DEPOIMENTO REAL SOBRE UMA CRIANÇA QUE PASSOU A PARTICIPAR MAIS DAS SESSÕES COM O APOIO DOS RECURSOS.]"
  },
  {
    id: "depo-2",
    ...
    quote: "[INSIRA AQUI UM DEPOIMENTO REAL SOBRE A ORGANIZAÇÃO POR DEMANDA E A REDUÇÃO DO TEMPO GASTO CRIANDO OU PROCURANDO ATIVIDADES.]"
  },
  {
    id: "depo-3",
    ...
    quote: "[INSIRA AQUI UM DEPOIMENTO REAL SOBRE CARTAS, JOGOS OU RECURSOS VISUAIS QUE AJUDARAM UMA CRIANÇA A NOMEAR EMOÇÕES OU FALAR SOBRE UMA SITUAÇÃO.]"
  }
];
