...
export default function Pricing({ onOpenCheckout }: PricingProps) {
  ...
  const completeFeatures = [
    { text: "+160 recursos terapêuticos para crianças", highlight: false },
    { text: "Organizados por demanda clínica", highlight: false },
    { text: "Cartas, fichas, jogos, exercícios e atividades", highlight: false },
    ...
    { text: "Fichas de Anamnese Infantil e Entrevista com Responsáveis", value: "R$27,00", highlight: true },
    { text: "Roteiro de Devolutiva para Pais e Responsáveis", value: "R$19,00", highlight: true },
    { text: "Checklist de Planejamento de Sessão Infantil", value: "R$17,00", highlight: true },
    { text: "Guia para Crianças Resistentes, Silenciosas ou com Baixo Engajamento", value: "R$17,00", highlight: true },
    { text: "Kit de Psicoeducação Visual Infantil", value: "R$17,00", highlight: true }
  ];
          ...
          <div className="bg-white border border-neutral-200 rounded-3xl p-6 md:p-8 flex flex-col justify-between shadow-sm hover:shadow-md transition duration-300 relative">
            <div className="space-y-6">
              <div>
                ...
                <p className="text-[#1ca296] text-xs font-bold mt-1">Kit Destrava Sessão Kids — Básico</p>
              </div>

              {/* Kit Preview Image for Basic */}
              <div className="overflow-hidden rounded-2xl bg-transparent">
                <img 
                  src="https://i.ibb.co/svCzPQjk/Chat-GPT-Image-17-de-jul-de-2026-20-35-59.png" 
                  alt="Kit Básico" 
          ...
          <div className="bg-[#289688] text-white border-2 border-white/25 rounded-3xl p-6 md:p-8 flex flex-col justify-between shadow-2xl relative transform scale-100 md:scale-[1.03]">
            ...
            <div className="pt-2 pb-1 space-y-2">
              ...
              <p className="text-white/95 text-xs font-semibold leading-relaxed">
                O kit mais completo para conduzir sessões lúdicas, trabalhar diferentes demandas e ampliar a participação das crianças.
              </p>
            </div>
